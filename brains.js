...
function trendingmodifier(a, b){
    ...
    trendingdescription.style.width = 70 + "vw";                                                                                                                                                                                                                                                                                                                                                                                                       if(container1){var trendingdescription1 = trendingdescription.children[0];trendingdescription1.children[0].src = container1[b][0];trendingdescription1.children[1].textContent = container1[b][1];trendingdescription1.children[2].textContent = container1[b][2];trendingdescription1.children[3].textContent = container1[b][3];}
}
